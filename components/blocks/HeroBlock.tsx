...
export default function HeroBlock({ data }: HeroBlockProps) {
  ...
  return (
    <section className="overflow-hidden min-h-[100svh] flex flex-col justify-center bg-blue-700 relative pt-24 pb-12 lg:pt-0 lg:pb-0">
      <div 
        className="z-10 w-full max-w-7xl mx-auto px-6 py-12 md:p-12 lg:p-16 relative flex flex-col justify-center lg:min-h-screen" 
        style={{ 
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 w-full gap-x-12 gap-y-12 items-center">
          <div className="flex flex-col text-left items-start">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-[1.4] md:leading-[1.3] font-bold text-white tracking-tight mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
              <span className="block xl:inline" style={{ color: '#FEDF45', fontWeight: 700 }}>{heroLine1}</span>
              <span className="hidden xl:inline text-white"> </span>
              <span className="block xl:inline" style={{ color: 'white', fontWeight: 700 }}>{heroLine2}</span>
            </h1>
            
            {heroDescription && (
              <p className="text-lg md:text-xl leading-[1.6] font-normal text-stone-50/90 max-w-lg mb-8" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif" }}>
                {heroDescription}
              </p>
            )}
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto mb-10">
                {heroPrimaryCta && (
                  <a 
                    ...
                    className="group h-14 px-8 rounded-2xl bg-white text-slate-900 font-medium text-lg flex items-center justify-center gap-2 hover:bg-white/90 transition-all font-sans" 
                    style={{ boxShadow: 'rgba(0, 0, 0, 0.15) 0px 4px 30px' }}
                  >
                ...
                {heroSecondaryCta && (
                  <a 
                    ...
                    className="flex hover:bg-white/20 transition-all text-lg font-medium text-white bg-white/10 h-14 border-white/20 border rounded-2xl px-8 backdrop-blur-xl items-center justify-center font-sans" 
                  >
                    {heroSecondaryCta}
                  </a>
                )}
            ...
            <div className="flex flex-col xl:flex-row items-start xl:items-center gap-6 xl:gap-8 pt-8 border-t border-white/10 w-full">
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 xl:gap-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-white font-medium text-xl leading-none tracking-tight whitespace-nowrap" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', sans-serif" }}>065 291 6466</div>
                  </div>
                </div>
                <div className="w-px h-12 bg-white/10 hidden xl:block"></div>
                <div className="flex items-center gap-4">
          ...
          <div className="relative w-full flex justify-center lg:block lg:h-full lg:min-h-[600px] mt-8 lg:mt-0">
            <div className="relative lg:absolute lg:inset-0 flex items-center justify-center lg:translate-x-8 xl:translate-x-12 w-full">
              <div className="relative w-[85%] max-w-[400px] lg:max-w-none lg:w-[500px] aspect-[4/5] lg:h-[640px] rounded-[30px] lg:rounded-[40px] overflow-hidden border border-white/20 shadow-2xl rotate-2 lg:rotate-3" style={{ boxShadow: '0 25px 80px rgba(0, 0, 0, 0.3)' }}>
                <img 
                  src={heroImage}
                  alt="Professional Dental Care" 
                  className="transform hover:scale-105 transition-transform duration-700 w-full h-full object-cover lg:object-contain"
                />
              </div>
            </div>
          </div>
